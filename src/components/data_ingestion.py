...
# in data ingestion inputs like saving details is created in this class
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            train_set.to_csv(self.ingestion_config.train_data_path,index=
            False,header=True)
            test_set.to_csv(self.ingestion_config.test_data_path,index=
            False,header=True)
            logging.info("igestion of data is completed")
            return(
